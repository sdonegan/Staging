...
#include "Staging/StagingDLLExport.h"

/**
 * @brief The StagingPlugin class
 */
class Staging_EXPORT StagingPlugin : public QObject, public ISIMPLibPlugin
{
    Q_OBJECT
    Q_INTERFACES(ISIMPLibPlugin)
    Q_PLUGIN_METADATA(IID "com.your.domain.StagingPlugin")

  public:
    StagingPlugin();
    virtual ~StagingPlugin();
  ...
  private:
    ...
    StagingPlugin(const StagingPlugin&); // Copy Constructor Not Implemented
    void operator=(const StagingPlugin&); // Operator '=' Not Implemented
};
